...
## Repository map
- `Cargo.lock/` — explain what lives here and when agents should edit it.
- `Cargo.toml/` — explain what lives here and when agents should edit it.
- `crates/` — explain what lives here and when agents should edit it.
- `docker-compose.prod.yml/` — explain what lives here and when agents should edit it.
